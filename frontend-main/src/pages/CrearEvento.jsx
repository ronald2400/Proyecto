  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (res.ok) {
            ...
            alert("Error al crear evento. Revisa los datos (Fechas, Capacidad).");
        }
    } catch (error) {
      ...
      <div className="admin-layout">
        ...
        <main className="admin-content">
          ...
          <form className="form-evento" onSubmit={handleSubmit}>
            ...
            {/* Por tiempo quite la imagen real porque el backend no la guarda, 
                pero deje el botón visual para mantener el diseño */}
