  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (res.ok) {
            ...
            alert("Error al actualizar. Revisa las fechas y datos.");
        }
    } catch (error) {
        console.error(error);
        ...
        <main className="admin-content">
          ...
          <form className="form-evento" onSubmit={handleSubmit}>
            ...
            <div className="form-group" style={{display: 'flex', gap: '10px'}}>
                ...
                <div style={{flex: 1}}>
                    <label>Estado</label>
                    <select name="estado" value={form.estado} onChange={handleChange} style={{width: '100%', padding: '10px'}}>
            ...
            <Link to="/admin/eventos">
              <button type="button" className="admin-btn outline">Cancelar</button>
            </Link>
          </form>
        </main>
      </div>
