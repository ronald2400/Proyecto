...
function EventCard({ evento }) {
  return (
    <div className="evento-card">
      <img src={eventoDefaultImg} alt={evento.nombre} />
      ...
      <div className="evento-info">
        ...
        <p style={{color: evento.cupos_disponibles > 0 ? 'inherit' : 'red'}}>
    ...
    <>
      ...
      <section className="eventos-section">
        <div className="eventos-header">
          ...
          <p>Elige tu evento, revisa los detalles y reserva en minutos.</p>
        </div>
